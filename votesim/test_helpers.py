...
def assert_list_almost_equal(test_obj: TestCase, correct_list: List, li: List, considered_equal_margin=0.0001, msg=""):
    """
    Assert that two lists are almost equal (within a margin of error).

    Args:
        test_obj: TestCase object that provides assertion methods
    ...
    """
    assert isinstance(test_obj, TestCase), "test_obj must be an instance of unittest.TestCase"
